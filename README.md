...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/haitwancu/toytry)  
...
* **务必替换所有的423857d0-b7b0-4b0f-bb84-cb01a05532e6为部署时设置的AUUID**  
...
* 端口：443
* 默认UUID：423857d0-b7b0-4b0f-bb84-cb01a05532e6
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 路径：/423857d0-b7b0-4b0f-bb84-cb01a05532e6-vless // 默认vless使用/$uuid-vless，vmess使用/$uuid-vmess
* 底层传输安全：tls
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "423857d0-b7b0-4b0f-bb84-cb01a05532e6"
    ],
    "websocket": {
        "enabled": true,
        "path": "/423857d0-b7b0-4b0f-bb84-cb01a05532e6-trojan",
...
* 插件选项: tls;host=appname.herokuapp.com;path=/423857d0-b7b0-4b0f-bb84-cb01a05532e6-ss
```
</details>
